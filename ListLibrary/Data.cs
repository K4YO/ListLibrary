...
namespace ListLibrary
{
    ...
    public abstract class Data : IComparable<Data>, IEquatable<Data> //Implementa o a interface IComparable para utilizar o Sort da lista, e método Equals() para comparar a igualdade valor
    {
        ...
        /// <summary>
        /// Compara esta instância com um bbjeto especificado e indica se essa instância precede, segue ou aparece na mesma posição na ordem de classificação como o objeto especificado.
        /// </summary>
